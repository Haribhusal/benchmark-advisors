              ...
              <div className="col-sm-4">
                <div className="factswrapper">
                  <div className="fact px-3 py-2 bg-success text_white text_w d-flex  justify-content-between align-items-center fact-green">
                    <div className="data font_p">$1,754,620</div>
                  ...
                  >
                    <Tab eventKey="detail" title="Details">
                      <p className="text-muted f14">
                        Lorem ipsum dolor sit amet, ipsum dolo dipiscing elit,
                        sed do eiusmod tempor incididunt consectetur adipiscing
                        elit.Lorem ipsum dolor sit amet, ipsum dolo dipiscing
                        elit, sed do eiusmod tempor incididunt consectetur
                        adipiscing elit lorem ipsum dolor sit amet, Lorem ipsum
                        dolor sit amet, ipsum dolo dipiscing elit, sed do
